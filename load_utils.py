...
def load_eeg_eye_data(data_root_eeg, data_root_eye, conditions, subjects):
    def encode_y(Y):
    ...
    return X_all_eeg, X_all_eye, Y_all, x_train_eeg, x_train_eye, x_test_eeg, x_test_eye, y_train, y_test
# PCA and t-sne for visualizing the category space ##############################################
